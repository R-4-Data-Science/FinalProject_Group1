...
The initial values for optimization were obtained from the least-squares formula (XTX)−1XTy. The parameters for this function should be a matrix of predictors with the first column being 1s to account for the intercept, and a vector for the response variable. The output produces a list consisting of the estimated coefficients (named "betas"), the predicted y-values using the estimated coefficientes (named "y_pred"), the initial y-values (named "y_actual"), and the initial X matrix (named "X").
